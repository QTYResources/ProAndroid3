...
public class ResourceTester extends BaseTester {
    ...
    private static final String TAG = ResourceTester.class.getSimpleName();

    public ResourceTester(Context ctx, IReportBack target) {
        super(ctx, target);
    }
    ...
    public void testXML() {
        try {
            ...
            reportString("error reading xml file: " + e.getMessage());
        }
    }

    private String getEventsFromAnXMLFile(Context activity) throws XmlPullParserException, IOException {
    ...
    public void testRawFile() {
        try {
            ...
            reportString("error: " + e.getMessage());
        }
    }
    ...
    private String getStringFromAssetFile(Context activity) throws IOException {
